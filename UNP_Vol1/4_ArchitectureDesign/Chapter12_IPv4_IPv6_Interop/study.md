...
| 节 | 目录 | 主题 |
|----|------|------|
| 12.1 | [12.1_Overview](./12.1_Overview/notes.md) | 过渡背景、双栈 |
| 12.2 | [12.2_IPv4_Client_IPv6_Server](./12.2_IPv4_Client_IPv6_Server/notes.md) | **IPv4 客 → IPv6 服** |
| 12.3 | [12.3_IPv6_Client_IPv4_Server](./12.3_IPv6_Client_IPv4_Server/notes.md) | **IPv6 客 → IPv4 服** |
| 12.4 | [12.4_IPv6_Address_Macro](./12.4_IPv6_Address_Macro/notes.md) | **V4MAPPED 宏** |
| 12.5 | [12.5_Source_Code_Portability](./12.5_Source_Code_Portability/notes.md) | 可移植黄金法则 |
| 12.6 | [12.6_Summary](./12.6_Summary/notes.md) | 全章收束 |
