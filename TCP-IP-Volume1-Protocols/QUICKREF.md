...
| 10 | UDP | 消息边界、v6 强制校验和、**分片连锁丢包**、[考点](chapter10-udp-ip-fragment/study.md#ch10-exam) | 单包 ≤1400B；[ch10 考点精读](chapter10-udp-ip-fragment/study.md#ch10-exam)；[§3.3 UDP](../03_transport_layer/study.md#ch3-3) |
...
| 12 | TCP 基础 | ARQ、**min(rwnd,cwnd)**、累积 ACK、[考点](chapter12-tcp-basic/study.md#ch12-exam) | [tcp_header.png](../03_transport_layer/assets/tcp_header.png) → [ch12](chapter12-tcp-basic/study.md) |
| 13 | TCP 连接 | 1.5 RTT、SYN Cookie、PMTUD/MSS、[考点](chapter13-tcp-connection-manage/study.md#ch13-exam) | TIME_WAIT、backlog → [ch13](chapter13-tcp-connection-manage/study.md) · [§3.1](../03_transport_layer/study.md#ch3-1-tcp-conn) |
