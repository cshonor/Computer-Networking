...
| **定向广播**（directed / subnet） | **某子网的「主机位全 1」地址** | **历史上可跨网段转发**；现今设备**默认禁止**转发到该子网 | 曾用于「远程唤醒整个子网」；**Smurf** 放大的温床 → 见 [§9.5](#ch09-5) 与 [ch08 §8.7](../chapter08-icmpv4-icmpv6/study.md#ch08-7) |
