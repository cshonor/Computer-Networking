...
**学习**：源 MAC + 入端口 → **MAC 表**  
**转发**：已知单播 → **单端口**；未知单播/广播/组播 → **泛洪**（不含入端口）  
**冲突域**：**每端口独立** · 全双工无 CSMA/CD · **广播域**：默认同一 · **VLAN** 隔离

→ [交换机标准答案](3.4-bridge-switch-stp.md#ch03-4-switch) · [STP](3.4-bridge-switch-stp.md#ch03-4-stp)
