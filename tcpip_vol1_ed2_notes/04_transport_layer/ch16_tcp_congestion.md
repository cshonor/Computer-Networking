...
> 流控：[ch15 rwnd](ch15_tcp_dataflow_window.md#ch15-5) · 重传：[ch14](ch14_tcp_timeout_retransmit.md) · 自顶向下：[§3.1 拥塞](../../03_transport_layer/study.md#ch3-1-tcp-cong)
...
整合 Reno 族 + [ch14](ch14_tcp_timeout_retransmit.md) 快速重传；快速恢复中 **dup ACK 与允许新发** 的「守恒」关系。
...
**Scoreboard** 精确定位空洞 → 少无效重传，丢包期维持较高有效利用率 → [ch14 §SACK](ch14_tcp_timeout_retransmit.md#ch14-6)
...
- 若伪超时 → **撤销** ssthresh/cwnd 削减 → [ch14 §14.7](ch14_tcp_timeout_retransmit.md#ch14-7)
...
- [ch17 Keepalive](ch17_tcp_keepalive.md)  
- [ch18 安全](../05_application_security/ch18_security.md)
