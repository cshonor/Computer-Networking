...
> 半开连接：[ch13 §RST](ch13_tcp_connection.md#ch13-6) · 零窗口探测：[ch15 Persist](ch15_tcp_dataflow_window.md#ch15-5) · NAT 超时：[ch07](../03_network_layer/ch07_firewall_nat.md)
...
| | 保活 Probe | Window Probe [ch15](ch15_tcp_dataflow_window.md#ch15-5) |
|--|------------|-----------------------------------------------------------|
| 原因 | **连接空闲** | 对端通告窗口 **= 0** |
| 目的 | 对端是否还活着 | 窗口何时变大 |
...
→ [ch07 NAT 状态](ch07_firewall_nat.md#ch07-3)
...
- 长连接、TIME_WAIT：[ch13](ch13_tcp_connection.md#ch13-5)
