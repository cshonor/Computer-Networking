...
> 前置：[ch12 滑动窗口](ch12_tcp_intro.md#ch12-1-2) · [ch13 WSCALE](ch13_tcp_connection.md#ch13-3) · 自顶向下：[§3.1 流控](../../03_transport_layer/study.md#ch3-1-tcp-flow)
...
→ 图示：[tcp_sliding_window.png](../../03_transport_layer/assets/tcp_sliding_window.png) · [ch12](ch12_tcp_intro.md#ch12-1-2)
...
**LFN / 大 BDP** 需 [Window Scale](ch13_tcp_connection.md#ch13-3)（突破 64KB）。
...
| 有效发送 | **min(rwnd, cwnd)** | 同左 → [ch12](ch12_tcp_intro.md#ch12-1-3) |
...
- [ch16 拥塞控制](ch16_tcp_congestion.md) — cwnd、慢启动
