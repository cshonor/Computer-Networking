...
> 前置：[ch12 TCP 初步](ch12_tcp_intro.md) · PMTUD：[ch08](../03_network_layer/ch08_icmpv4_icmpv6.md#ch08-3) · 自顶向下：[§3.1 连接/状态机](../../03_transport_layer/study.md#ch3-1-tcp-conn)
...
| **中间盒 (13.2.6)** | NAT/防火墙改写或丢弃 SYN/选项 → [ch07](../03_network_layer/ch07_firewall_nat.md) |
...
→ [ch08](../03_network_layer/ch08_icmpv4_icmpv6.md#ch08-3) · 防火墙**勿拦**此类 ICMP
...
→ 中间盒：[ch07](../03_network_layer/ch07_firewall_nat.md#ch07-7)
...
- [ch14 超时与重传](ch14_tcp_timeout_retransmit.md)  
- [ch15 数据流与窗口](ch15_tcp_dataflow_window.md)
