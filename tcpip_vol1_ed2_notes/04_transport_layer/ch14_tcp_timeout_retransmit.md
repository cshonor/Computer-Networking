...
> 前置：[ch12](ch12_tcp_intro.md#ch12-1-4) · [ch13 选项/时间戳](ch13_tcp_connection.md#ch13-3) · 自顶向下：[§3.1 可靠/快速重传](../../03_transport_layer/study.md#ch3-1-tcp-reliable)
...
| **RTTM（时间戳选项）** | 每段（含重传）可测 RTT → **绕过 Karn 限制**；兼 **PAWS** [ch13](ch13_tcp_connection.md#ch13-3) |
...
→ 协商：[ch13 §SACK](ch13_tcp_connection.md#ch13-3)
...
- [ch15 数据流与窗口](ch15_tcp_dataflow_window.md) — rwnd、Nagle  
- [ch16 拥塞控制](ch16_tcp_congestion.md) — 超时与 cwnd
