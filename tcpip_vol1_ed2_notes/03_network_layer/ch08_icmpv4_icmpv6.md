...
> 前置：[ch05 IP](ch05_ip.md) · [ch04 ARP](ch04_arp.md) · [ch06 SLAAC](ch06_dhcp.md#ch06-3) · [ch07 边界](ch07_firewall_nat.md)
...
→ IPv4 ARP：[ch04](ch04_arp.md) · v6 用 ND 见 §8.5
...
- TTL 减至 0 → **Time Exceeded**：[ch05 §5.2](ch05_ip.md#ch05-2)  
- MTU 超限（v6）→ **Packet Too Big**：[ch03 MTU](../02_link_layer/ch03_link_layer.md#ch03-8)
...
**地址掩码请求**、**时间戳请求** 等在 v6 由 **ND + SLAAC** 取代 → [ch06](ch06_dhcp.md#ch06-3)

### 移动 IPv6（概念）

**移动前缀请求/通告** 等 ICMPv6 扩展，支撑归属前缀与转交地址刷新（与 [ch05 Mobile IP](ch05_ip.md#ch05-5) 呼应）。
...
→ 与 [ch07 NAT64](ch07_firewall_nat.md#ch07-6) 控制面协同
...
- 结合 [ch07](ch07_firewall_nat.md#ch07-7) 状态表与 uRPF
...
- [ch09 广播/多播](../04_transport_layer/ch09_broadcast_multicast.md) — IGMP/MLD  
- [ch10 UDP](../04_transport_layer/ch10_udp.md) — 端口不可达、PMTUD  
- [ch07 防火墙](ch07_firewall_nat.md) — ICMP 过滤策略
