...
> 前置：[ch05 IP](ch05_ip.md) · [ch04 ARP](ch04_arp.md) · 自顶向下：[§4.3 DHCP](../../04_network_layer_data_plane/study.md#ch4-3)
...
→ 免费 ARP/ACD：[ch04 §4.5](ch04_arp.md#ch04-5)
...
→ ND/ICMPv6：[ch08](ch08_icmpv4_icmpv6.md)
...
→ [ch11 DNS](../05_application_security/ch11_dns.md)

### PPPoE

宽带接入：将带**认证**的 **PPP** 封装进以太网；**发现阶段 + 会话阶段** 分发 IP — 运营商拨号常见。

→ [ch03 §PPP](../02_link_layer/ch03_link_layer.md#ch03-6)（PPP 帧格式见链路层章）
