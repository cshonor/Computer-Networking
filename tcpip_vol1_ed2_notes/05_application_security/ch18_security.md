...
> DNS：[ch11](ch11_dns.md) · 防火墙/NAT：[ch07](../03_network_layer/ch07_firewall_nat.md) · 自顶向下：[08_network_security/study.md](../../08_network_security/study.md)
...
| **可用性 (A)** | **DoS/DDoS** — 如 [SYN Flood](../04_transport_layer/ch13_tcp_connection.md#ch13-8) |

### 欺骗 (Spoofing)

**IP 源地址伪造** → 绕过基于 IP 的信任 → [ch05](../03_network_layer/ch05_ip.md#ch05-7)、BCP38
...
→ 自顶向下：[08 §8.4 IPsec](../../08_network_security/8.4_ipsec_vpn/study.md)
...
→ [08 §8.3 TLS/HTTPS](../../08_network_security/8.3_tls_https/study.md)
...
| 机制 | 作用 |
|------|------|
| **DNSSEC** | **RRSIG / DNSKEY / DS** 签名链 → 防缓存污染 → [ch11](ch11_dns.md) |
...
传输层精读：[ch10–ch17](../04_transport_layer/) · 体系原则：[ch01](../01_architecture/ch01_introduction.md)
