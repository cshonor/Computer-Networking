...
> 传输载体：[ch10 UDP/53](../04_transport_layer/ch10_udp.md) · 地址：[ch02](../01_architecture/ch02_internet_addresses.md) · 自顶向下：[§2.4 DNS](../../02_application_layer/study.md#ch2-4)
...
→ [ch07 NAT64/DNS64](../03_network_layer/ch07_firewall_nat.md#ch07-6)（仅 v6 客户端访问 v4 服务）
...
→ 组播语境：[ch09](../04_transport_layer/ch09_broadcast_multicast.md)
...
→ [ch10 反射](../04_transport_layer/ch10_udp.md#ch10-14) · [ch07](../03_network_layer/ch07_firewall_nat.md)

### DDNS（与 ch06）

DHCP 变更 IP 时更新 **A/AAAA** → [ch06 §6.4](../03_network_layer/ch06_dhcp.md#ch06-4)
...
- [ch12 TCP](../04_transport_layer/ch12_tcp_intro.md)  
- [ch18 安全](ch18_security.md) — DNSSEC、TLS

---

## Top-Down

- [02_application_layer/study.md §2.4](../../02_application_layer/study.md#ch2-4)
